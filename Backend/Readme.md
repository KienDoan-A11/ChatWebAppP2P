...
Sử dụng JWT để bảo mật các endpoint, đảm bảo rằng chỉ những người dùng đã xác thực mới có thể truy cập vào một số chức năng của ứng dụng (nếu cần mở rộng).
